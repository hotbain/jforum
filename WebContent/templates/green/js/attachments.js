...
<#if attachmentsEnabled>
	...
	template +="<tr><td>${I18n.getMessage("jforum_need_money")}</td><td><input type='text' size='50' name='needMoney_#num#'></td></tr>";
...
<#if attachments?exists>
	...
	templateEdit +="<tr><td>${I18n.getMessage("jforum_need_money")}</td><td><input type='text' size='50' name='edit_needMoney_#id#' value='#va#'></td></tr>";
	...
	function editAttachments()
	{
		...
		<#list attachments as a>
			...
			attach_${a.id}["needMoney"] = "${(a.info.needMoney)?default("")}";
